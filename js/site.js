...
const translations = {
  en: {
    ...
    stripCrypto: 'USDT and RUB checkout',
    stripAi: 'night history',
    stripAndroid: 'from 990 ₽ / USDT 12.99/month',
    ...
    premiumPillThree: 'USDT + RUB checkout',
    ...
    priceMonthlyText: '30 days of Premium access: 990 ₽ or USDT 12.99.',
    priceYearlyLabel: 'Yearly',
    priceYearlyText: '366 days of Premium access: 5 390 ₽ or USDT 69.99.',
    ...
    documentsText: 'Before payment, buyers can check who operates the service, what Premium includes, how much it costs, how access is provided, and how cancellation or refund requests work.',
    documentsContactsLabel: 'Contacts',
    documentsContactsTitle: 'Project and support details',
    documentsContactsText: 'E-mail, store information, and support rules.',
    ...
    footerSeller: '© 2026 Sleep Tracker AI. Operator: Dmitry Evseev.',
    footerOffer: 'Offer',
    footerRefund: 'Refund',
  ...
  ru: {
    ...
    scroll: 'Скролл',
    stripApk: 'Android beta APK',
    stripCrypto: 'Оплата USDT и рублями',
    stripAi: 'история ночей',
    stripAndroid: 'от 990 ₽ / USDT 12.99 в месяц',
    ...
    premiumPillThree: 'USDT и RUB оплата',
    ...
    priceMonthlyText: '30 дней Premium-доступа: 990 ₽ или USDT 12.99.',
    priceYearlyLabel: 'Годовой',
    priceYearlyText: '366 дней Premium-доступа: 5 390 ₽ или USDT 69.99.',
    ...
    documentsText: 'До оплаты покупатель может проверить, кто ведет проект, что входит в Premium, сколько это стоит, как выдается доступ и как работает отказ от покупки или возврат.',
    documentsContactsLabel: 'Контакты',
    documentsContactsTitle: 'Проект и поддержка',
    documentsContactsText: 'E-mail, данные магазина и правила поддержки.',
    ...
    footerSeller: '© 2026 Sleep Tracker AI. Оператор: Дмитрий Евсеев.',
    footerOffer: 'Оферта',
